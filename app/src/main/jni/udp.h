...
extern u8 ui_recvbuf[UI_BUFF_SIZE];

#define IP_SIZE     16
extern char local_ip[IP_SIZE];
extern struct sockaddr_in sender,ui_sender;
extern int sender_len, ui_sender_len;

extern SOCKET  primary_udp;
extern SOCKET  ui_socket;
...
extern lock_linked_list lock_list;
extern valve_linked_list valve_list;
extern frair_linked_list frair_list;
extern tv_linked_list tv_list;
extern tvUP_linked_list tvUP_list;
