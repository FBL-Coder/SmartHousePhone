package cn.etsoft.smarthome.ui.UserInterface;
...
public class Air_Control extends Activity implements View.OnClickListener {
    ...
    private void initData() {
        ...
        if (mAirCondDev.getbOnOff() == 0) mAirSwitch.setImageResource(R.drawable.off);
        else mAirSwitch.setImageResource(R.drawable.on);
