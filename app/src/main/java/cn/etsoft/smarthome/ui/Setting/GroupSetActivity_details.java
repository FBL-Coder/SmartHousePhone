...
public class GroupSetActivity_details extends Activity implements View.OnClickListener, VerticalPageSeekBar.OnSeekBarPageChangeListener {
    ...
    private void initTitleBar() {
        ...
        title.setText("");
        title.setHint(MyApplication.getWareData().getmGroupSet_Data().getSecs_trigger_rows().get(GroupSet_position).getTriggerName());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.title_bar_tv_room://保存
                AlertDialog.Builder builder = new AlertDialog.Builder(GroupSetActivity_details.this
