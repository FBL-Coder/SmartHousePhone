            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                builder.setPositiveButton("删除", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        ...
                        ToastUtil.showToast(ConditionEventActivity_details.this, "删除成功");
                    }
                });
                builder.create().show();
                return true;
                        ...
                        try {
                            ...
                            if ("".equals(et_name.getText().toString())) {
                                ...
                                try {
                                    ...
                                    ToastUtil.showToast(ConditionEventActivity_details.this, "触发器名称不合适");
                                    return;
                                }
                            }
                            if (et_name.getText().toString().length() > 24) {
                                ToastUtil.showToast(ConditionEventActivity_details.this, "触发器名称不能过长");
                                return;
                            }
                            ...
                            if ("输入触发值".equals(input_num.getText().toString()) || "".equals(input_num.getText().toString())) {
                                ToastUtil.showToast(ConditionEventActivity_details.this, "触发器阀值不能为空");
                                return;
                            }
                            ...
                            if ("点击选择触发方式".equals(event_way.getText().toString())) {
                                ToastUtil.showToast(ConditionEventActivity_details.this, "请选择触发方式");
                                return;
                            }
                            ...
                            if ("点击选择触发类别".equals(event_type.getText().toString())) {
                                ToastUtil.showToast(ConditionEventActivity_details.this, "请选择触发类别");
                                return;
                            }
                            ...
                            ToastUtil.showToast(ConditionEventActivity_details.this, "保存数据异常,请检查数据是否合适");
                        }
                    }
                });
                builder.create().show();
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (tag) {
                            if (common_dev.size() == 4) {
                                ToastUtil.showToast(ConditionEventActivity_details.this, "定时设备最多4个！");
                                return;
                            }
