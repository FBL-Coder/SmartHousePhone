...
public class ParlourGridViewAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (dev_list.get(position).getType() == 0) {
            ...
            lightList = MyApplication.getWareData_Scene().getLights();
            ...
            curtainList = MyApplication.getWareData_Scene().getCurtains();
            ...
            public void onClick(View view) {
                if (dev_list.get(position).getType() == 0) {
                    for (int i = 0; i < MyApplication.getWareData_Scene().getAirConds().size(); i++) {
                        if (dev_list.get(position).getDevId() == MyApplication.getWareData_Scene().getAirConds().get(i).getDev().getDevId() && dev_list.get(position).getCanCpuId().equals(MyApplication.getWareData_Scene().getAirConds().get(i).getDev().getCanCpuId())) {
                            AirCondDev = MyApplication.getWareData_Scene().getAirConds().get(i);
                    ...
                    for (int i = 0; i < MyApplication.getWareData_Scene().getTvs().size(); i++) {
                        if (dev_list.get(position).getDevId() == MyApplication.getWareData_Scene().getTvs().get(i).getDev().getDevId() && dev_list.get(position).getCanCpuId().equals(MyApplication.getWareData_Scene().getTvs().get(i).getDev().getCanCpuId())) {

                            TV = MyApplication.getWareData_Scene().getTvs().get(i);
                            if (TV.getbOnOff() == 0) {
                                TV.setbOnOff((byte) 1);
                    ...
                    for (int i = 0; i < MyApplication.getWareData_Scene().getStbs().size(); i++) {
                        if (dev_list.get(position).getDevId() == MyApplication.getWareData_Scene().getStbs().get(i).getDev().getDevId() && dev_list.get(position).getCanCpuId().equals(MyApplication.getWareData_Scene().getStbs().get(i).getDev().getCanCpuId())) {

                            TVUP = MyApplication.getWareData_Scene().getStbs().get(i);
                            if (TVUP.getbOnOff() == 0) {
                    ...
                    for (int i = 0; i < MyApplication.getWareData_Scene().getLights().size(); i++) {
                        if (dev_list.get(position).getDevId() == MyApplication.getWareData_Scene().getLights().get(i).getDev().getDevId() && dev_list.get(position).getCanCpuId().equals(MyApplication.getWareData_Scene().getLights().get(i).getDev().getCanCpuId())) {
                            Light = MyApplication.getWareData_Scene().getLights().get(i);
                    ...
                    for (int i = 0; i < MyApplication.getWareData_Scene().getCurtains().size(); i++) {
                        if (dev_list.get(position).getDevId() == MyApplication.getWareData_Scene().getCurtains().get(i).getDev().getDevId() && dev_list.get(position).getCanCpuId().equals(MyApplication.getWareData_Scene().getCurtains().get(i).getDev().getCanCpuId())) {
                            Curtain = MyApplication.getWareData_Scene().getCurtains().get(i);
