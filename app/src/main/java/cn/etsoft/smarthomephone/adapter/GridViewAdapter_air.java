...
import cn.etsoft.smarthomephone.domain.GridViewBean;

/**
 * Created by Say GoBay on 2016/9/1.
 */
public class GridViewAdapter_air extends BaseAdapter {
    private LayoutInflater mInflater;
    private List<GridViewBean> listViewItems;

    public GridViewAdapter_air(int[] image, String[] title, Context context) {
        super();
